      ...
      <tbody>
        <tr v-for="(config) in configs" :key="config.id">
          ...
          <td class="mb-2">
            ...
            <button v-if="isMobile" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#configDeleteModal"
              @click="openDeleteModal(config.id)">
              Del
            </button>
            <button v-else class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#configDeleteModal"
              @click="openDeleteModal(config.id)">
              Delete
            </button>
          </td>
