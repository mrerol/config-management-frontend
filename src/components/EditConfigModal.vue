        ...
        <div class="modal-body">
          <form @submit.prevent="configEditForm">
            <div class="form-group">
              ...
              <input v-model="config.paramKey" type="text" class="form-control" required />
            </div>
            <div class="form-group">
              <label class="form-label">Value</label>
              <input v-model="config.value" type="text" class="form-control" required />
            </div>
            <div class="form-group">
              <label class="form-label">Description</label>
              <input v-model="config.description" type="text" class="form-control" required />
            </div>
            <div class="mt-2">
